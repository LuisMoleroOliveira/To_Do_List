...
package br.com.molero.todolist.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton fabAdd, @NonNull EmptyStateBinding includeEmpty,
      @NonNull RecyclerView rvTasks, @NonNull TextView titleTextview) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, fabAdd, binding_includeEmpty,
          rvTasks, titleTextview);
    }
